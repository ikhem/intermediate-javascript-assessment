...
String.prototype.grammarPolice = function(){
  var newStrArray = this.toLowerCase().split('');
  
  for( var x = newStrArray.length; x > 0; x--)
    if((newStrArray[x-1]) === " ")
      newStrArray[x] = newStrArray[x].toUpperCase();
  
  //Always capitalizes the first letter of the sentence
